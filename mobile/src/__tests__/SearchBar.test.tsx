...
jest.mock('../components/search-bar/RouteCard', () => {
    ...
    return ({
        ...
        <View testID="route-card">
            ...
            <Text testID="back-trigger" onPress={onBack}>Back</Text>
            <Text testID="swap-trigger" onPress={onSwap}>Swap</Text>
        </View>
    );
});
...
describe('SearchBar', () => {
    ...
    it('renders the placeholder text', () => {
        const { getByText } = render(<SearchBar {...baseProps} placeholder="Where to?" />);
    ...
    it('renders RouteCard when isConfiguring is true', () => {
        const { getByTestId } = render(
            <SearchBar {...baseProps} isConfiguring />,
        );
    ...
    it('renders NavigationBar when isNavigating is true', () => {
        const { getByTestId } = render(
            <SearchBar {...baseProps} isNavigating />,
        );
    ...
    it('passes destinationLabel to RouteCard', () => {
        const { getByText } = render(
            <SearchBar {...baseProps} isConfiguring destinationLabel="Loyola Campus" />,
        );
