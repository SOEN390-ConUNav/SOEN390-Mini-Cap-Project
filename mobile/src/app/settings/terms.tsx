...
export default function SettingsTerms() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        <Text style={[styles.lastUpdated, { color: colors.textMuted }]}>Last Updated: March 2, 2026</Text>
        ...
        <Text style={[styles.sectionTitle, { color: colors.text }]}>2. Acceptable Use</Text>
        <Text style={[styles.paragraph, { color: colors.textMuted }]}>
        ...
        <Text style={[styles.bullet, { color: colors.textMuted }]}>
          • In any way that violates any applicable federal, provincial, local,
        ...
        <Text style={[styles.bullet, { color: colors.textMuted }]}>
          ...
          University employee, another user, or any other person or entity.
        </Text>
        ...
        <Text style={[styles.paragraph, { color: colors.textMuted }]}>
          ...
          features. By enabling location services, you consent to the
          collection, use, and sharing of your location data as described in our
          Privacy Policy. You may disable location services at any time through
          your device settings, but this may limit the functionality of the App.
        </Text>
        ...
        <Text style={[styles.paragraph, { color: colors.textMuted }]}>
          ...
          modify, and distribute such content for the purpose of improving the
          App and University services.
        </Text>

        <Text style={[styles.sectionTitle, { color: colors.text }]}>5. Intellectual Property</Text>
        <Text style={[styles.paragraph, { color: colors.textMuted }]}>
        ...
        <Text style={[styles.sectionTitle, { color: colors.text }]}>6. Disclaimer of Warranties</Text>
        <Text style={[styles.paragraph, { color: colors.textMuted }]}>
          The App is provided on an &quot;as is&quot; and &quot;as
          available&quot; basis. The University makes no representations or
          warranties of any kind, express or implied, regarding the operation or
          availability of the App, or the accuracy or reliability of any
        ...
        <Text style={[styles.sectionTitle, { color: colors.text }]}>8. Changes to These Terms</Text>
        <Text style={[styles.paragraph, { color: colors.textMuted }]}>
        ...
        <Text style={[styles.paragraph, { color: colors.textMuted }]}>
          If you have questions about these Terms, please contact the course
          staff or project maintainers associated with ConUNav.
        </Text>
      </ScrollView>
    </View>
  );
