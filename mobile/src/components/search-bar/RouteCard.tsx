// src/components/search-bar/RouteCard.tsx
...
export default function RouteCard({ originLabel, destinationLabel, onBack, onSwap }: RouteCardProps) {
    ...
    return (
        <View style={styles.card}>
            ...
            <CircleIconButton icon="arrow-back" onPress={() => { setIsLoading(false); onBack(); }} />
