    ...
    <View style={[styles.searchContainer, { top: statusBarHeight + 16 }]}>
      ...
      {(buildingName || floor) && (
        <View style={styles.buildingInfo}>
          <Text style={styles.buildingInfoText}>
            {buildingName || 'Hall Building'}{floor ? ` - Floor ${floor}` : ' - Floor 8'}
          </Text>
        </View>
      )}
      ...
      <View style={styles.card}>
        ...
        <View style={styles.bodySection}>
          ...
          {/* Swap Button */}
          <TouchableOpacity
            style={[styles.swapButton, (!startRoom || !endRoom) && styles.swapButtonDisabled]}
            onPress={onSwap}
            disabled={!startRoom || !endRoom}
          >
            <Text style={[styles.swapIcon, (!startRoom || !endRoom) && styles.swapIconDisabled]}>
              ⇄
            </Text>
          </TouchableOpacity>
